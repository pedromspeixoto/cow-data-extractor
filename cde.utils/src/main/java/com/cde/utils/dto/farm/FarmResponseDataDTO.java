...
public class FarmResponseDataDTO {
    ...
    public FarmResponseDataDTO() {
    }

    public FarmResponseDataDTO(String farmId, String farmDescription, byte[] farmPicture, String farmStatus, String farmAddress, String ownerName, String ownerPhoneNumber, String ownerEmail, Double latitude, Double longitude) {
        this.farmId = farmId;
