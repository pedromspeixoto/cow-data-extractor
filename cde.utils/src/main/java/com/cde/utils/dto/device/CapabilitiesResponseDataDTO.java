...
public class CapabilitiesResponseDataDTO {
    ...
    public CapabilitiesResponseDataDTO() {
    }

    public CapabilitiesResponseDataDTO(Boolean accelerometer, Boolean gyroscope, Boolean gps, Boolean temperature, Boolean humidity) {
