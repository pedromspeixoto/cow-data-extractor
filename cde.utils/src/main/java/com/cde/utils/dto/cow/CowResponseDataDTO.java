...
public class CowResponseDataDTO {
    ...
    public CowResponseDataDTO() {

    }

    public CowResponseDataDTO(String cowName, String cowDescription, byte[] cowPicture, LocalDate birthDate, Double weight) {
